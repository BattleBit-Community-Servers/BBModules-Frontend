                ...
                <div className="flex flex-col gap-3">
                    <p
                        className={`my-2 flex items-center ${
                            !(module.versions[0].Version_approved ?? true) ? "text-yellow-500" : ""
                        }`}
                    >
                        <History className="mr-2 h-4 w-4" />
                        Latest version: {module.versions[0].Version_v_number}
                    </p>
                    <Link to={`${import.meta.env.VITE_API_URL}/Download/${module.Module_name}/latest`}>
                                            ...
                                            <CardFooter>
                                                <SheetClose asChild>
                                                    <Button
                                                        ...
                                                        onClick={() =>
                                                            toast.promise(
                                                                approveVersion(module.versions[0].Version_id),
                                                                {
                                                ...
                                                <SheetClose asChild>
                                                    <Button
                                                        ...
                                                        onClick={
                                                            () =>
                                                                toast.promise(
                                                                    denyVersion(module.versions[0].Version_id),
                                                                    {
